module.exports = {
  async up(db, client) {
    // Rename the "igIds" property to "referencedBy" in the fhirResource collection
    ...
    console.log(
      `Renamed "igIds" to "referencedBy" for ${results.modifiedCount} resources in the "fhirResource" collection`
    );
  ...
  async down(db, client) {
    ...
    // Rename the "referencedBy" property to "igIds" in the fhirResource collection
    results = await db.collection('fhirResource').updateMany(
    ...
    console.log(
      `Renamed "referencedBy"to "igIds" for ${results.modifiedCount} resources in the "fhirResource" collection`
    );
  },
};
