...
class PageDefinition {
  ...
  public parent?: ImplementationGuideDefinitionPage;
  public level: number;
}
...
export class R5ImplementationGuideComponent extends BaseImplementationGuideComponent implements OnInit, OnDestroy, DoCheck, CanComponentDeactivate {
  ...
  public selectedResource: ImplementationGuideDefinitionResource;
  ...
  public get resources(): ImplementationGuideDefinitionResource[] {
    ...
    return (this.implementationGuide.definition.resource || [])
      .filter((resource: ImplementationGuideDefinitionResource) => {
  ...
  public moveGroupUp(group: ImplementationGuideDefinitionGrouping) {
  ...
  public moveGroupDown(group: ImplementationGuideDefinitionGrouping) {
    const index = this.implementationGuide.definition.grouping.indexOf(group);
  ...
  public editGroup(group: ImplementationGuideDefinitionGrouping) {
    ...
    modalRef.result.then((result: ImplementationGuideDefinitionGrouping) => {
  ...
  public removeGroup(group: ImplementationGuideDefinitionGrouping) {
  ...
  public moveResource(resource: ImplementationGuideDefinitionResource, direction: 'up' | 'down') {
  ...
  public addResources() {
    ...
    modalRef.result.then((results: ResourceSelection[]) => {
      ...
      if (!this.implementationGuide.definition) {
        this.implementationGuide.definition = new ImplementationGuideDefinition();
        this.implementationGuide.definition.resource = [];
      }
  ...
  public isDuplicateResource(resource: ImplementationGuideDefinitionResource) {
    ...
    const found = (this.implementationGuide.definition.resource || []).filter((next: ImplementationGuideDefinitionResource) =>
  ...
  public removeResource(resource: ImplementationGuideDefinitionResource) {
  ...
  public selectPublishedIg(dependsOn: ImplementationGuideDependsOn) {
  ...
  public toggleRootPage(value: boolean) {
    ...
    if (value && !this.implementationGuide.definition.page) {
      this.implementationGuide.definition.page = new ImplementationGuideDefinitionPage();
  ...
  public editPage(pageDef: PageDefinition) {
    ...
    modalRef.result.then((page: ImplementationGuideDefinitionPage) => {
  ...
  public addChildPage(pageDef: PageDefinition, template?: 'downloads') {
    ...
    const newPage = new ImplementationGuideDefinitionPage();
  ...
  public getDependsOnName(dependsOn: ImplementationGuideDependsOn) {
  ...
  public setDependsOnName(dependsOn: ImplementationGuideDependsOn, name: any) {
  ...
  public getDependsOnLocation(dependsOn: ImplementationGuideDependsOn) {
  ...
  public setDependsOnLocation(dependsOn: ImplementationGuideDependsOn, location: any) {
    if (!dependsOn.extension) {
      dependsOn.extension = [];
    }
  ...
  private initPage(page: ImplementationGuideDefinitionPage, level = 0, parent?: ImplementationGuideDefinitionPage) {
    if (!page) {
      return;
    }
        ...
        if (this.selectedPage && this.selectedPage.page === this.implementationGuide.definition.page && event.code === 'ArrowDown') {
          ...
          if (event.code === 'ArrowUp') {
            ...
            if (this.selectedPage.page.page && this.selectedPage.page.page.length > 0) {
              ...
              const findNextParentSibling = (nextParent: ImplementationGuideDefinitionPage) => {
  ...
  public isDescriptionRequired(resource: ImplementationGuideDefinitionResource) {
  ...
  public setExampleCanonical(resource: ImplementationGuideDefinitionResource, value: string) {
    delete resource.exampleBoolean;
    resource.exampleCanonical = value;
  }

  public selectExampleCanonical(resource: ImplementationGuideDefinitionResource) {
