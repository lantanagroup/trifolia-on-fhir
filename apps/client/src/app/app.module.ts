...
import { CustomPublishSettingsComponent } from './publish/custom-publish-settings/custom-publish-settings.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ExamplesComponent, BulkEditComponent, PageWrapperComponent, R4PageComponent, STU3PageComponent, IgnoreWarningsComponent, JiraSpecComponent, CustomMenuComponent, SecurityServicesComponent, PublishingTemplateComponent, CustomPublishSettingsComponent
  ],
  imports: [
