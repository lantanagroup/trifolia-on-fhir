...
const appRoutes: Routes = [
  ...
  {
    path: ':fhirServer/:implementationGuideId/operation-definition/:id',
    component: OperationDefinitionComponent,
    runGuardsAndResolvers: 'always'
  },
  {path: ':fhirServer/:implementationGuideId/value-set', component: ValuesetsComponent},
  {
    path: ':fhirServer/:implementationGuideId/value-set/:id',
    component: ValuesetComponent,
    runGuardsAndResolvers: 'always'
  },
  {
    path: ':fhirServer/:implementationGuideId/value-set/:id/expand',
    component: ValuesetExpandComponent,
    runGuardsAndResolvers: 'always'
  },
  {path: ':fhirServer/:implementationGuideId/code-system', component: CodesystemsComponent},
  {
    path: ':fhirServer/:implementationGuideId/code-system/:id',
...
@NgModule({
  ...
  declarations: [
    ...
    ExamplesComponent, BulkEditComponent, PageWrapperComponent, R4PageComponent, STU3PageComponent, IgnoreWarningsComponent, JiraSpecComponent, CustomMenuComponent, SecurityServicesComponent, PublishingTemplateComponent, NewProjectComponent, MergeUserModalComponent
